/**
 * Shared Zada prospective Professor v3 smoke execution path — used by runner and sealing tests.
 */
import {
...
import {
  ...
  buildProfessorV3ZadaExecutableSmokeMaterialPinReportV1,
  type ProfessorV3ReviewedExecutionIdentityV10,
} from "./phase6a1-professor-v3-smoke-material-pins-v10";
import {
...
export const PROFESSOR_V3_ZADA_PROSPECTIVE_SMOKE_EXECUTION_V1_VERSION =
  "phase6a1-professor-v3-zada-prospective-smoke-execution-v1";
...
export type ProfessorV3ZadaProspectiveSmokeExecutionBlockedV1 = {
  blocked: true;
  version: typeof PROFESSOR_V3_ZADA_PROSPECTIVE_SMOKE_EXECUTION_V1_VERSION;
...
export type ProfessorV3ZadaProspectiveSmokeExecutionCompletedV1 = {
  blocked: false;
  version: typeof PROFESSOR_V3_ZADA_PROSPECTIVE_SMOKE_EXECUTION_V1_VERSION;
  gate: ProfessorV3SmokeExecutionGateEvaluationV1;
  runner: ProfessorV3SmokeRunnerCaseBindingV1;
  authorization: ProfessorV3IndependentlyReviewedExecutionAuthorizationV8;
  reviewedExecutionIdentity: ProfessorV3ReviewedExecutionIdentityV10;
  outputTargets: ProfessorV3SmokeOutputTargetsV6;
  ...
  materialPinReport: ReturnType<typeof buildProfessorV3ZadaExecutableSmokeMaterialPinReportV1>;
...
export type ProfessorV3ZadaProspectiveSmokeExecutionResultV1 =
  | ProfessorV3ZadaProspectiveSmokeExecutionBlockedV1
  | ProfessorV3ZadaProspectiveSmokeExecutionCompletedV1;
...
export async function runProfessorV3ZadaProspectiveSmokeExecutionV1(args: {
  authorization: ProfessorV3IndependentlyReviewedExecutionAuthorizationV8;
...
}): Promise<ProfessorV3ZadaProspectiveSmokeExecutionResultV1> {
  ...
  const targets = resolveProfessorV3SmokeZadaProspectiveOutputTargetsV1(milestonesDir);
  const runner = buildProfessorV3ZadaProspectiveRunnerBindingV1({ decision: args.authorization.decision });
  ...
  if (gate.status !== "PREFLIGHT_ELIGIBLE") {
    return {
      blocked: true,
      version: PROFESSOR_V3_ZADA_PROSPECTIVE_SMOKE_EXECUTION_V1_VERSION,
      gate,
      runner,
      authorization: args.authorization,
      outputTargets: targets,
      blockedArtifact: emitProfessorV3SmokeExecutionGateBlockedArtifactV1({
        version: "phase6a1-professor-v3-smoke-zada-prospective-blocked-v1",
  ...
  const identityVerification = assertProfessorV3ZadaExecutableSmokeExecutionPreflightV11({
    authorization: args.authorization,
  });
  const materialPinReport = buildProfessorV3ZadaExecutableSmokeMaterialPinReportV1(identityVerification);
  ...
  const rawModelCaller = createProfessorV3ModelCallerV4({
    ...
    relPrefix: "phase6a1-professor-v3-smoke-zada-prospective-model-attempts-v1",
  ...
  try {
    ...
    if (!entry) throw new Error(`Missing Zada mechanism truth for ${runner.mechanismTruthCaseId}`);
  ...
  let reachedStage: ProfessorV3ZadaProspectiveSmokeExecutionCompletedV1["reachedStage"] =
