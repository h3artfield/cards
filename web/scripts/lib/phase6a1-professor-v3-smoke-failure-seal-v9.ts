/**
 * Write-once forensic seal for Yuriko prospective Professor v3 smoke failures (v9).
 */
...
} from "./phase6a1-professor-v3-yuriko-model-request-boundary-v1";
import {
...
export const PROFESSOR_V3_SMOKE_FAILURE_SEAL_V9_VERSION = "phase6a1-professor-v3-smoke-failure-seal-v9";

export type ProfessorV3SmokeFailureSealV9 = {
  version: typeof PROFESSOR_V3_SMOKE_FAILURE_SEAL_V9_VERSION;
  generatedAt: string;
  decision: string;
  caseId: string;
...
function resolveFailureErrorMetadata(error: unknown): {
  ...
  if (isProfessorV3YurikoModelRequestBoundaryErrorV1(error)) {
    return {
...
export function enumerateProfessorV3PartialModelAttemptFilesV9(modelAttemptsDir: string): ProfessorV3PartialModelAttemptFileV1[] {
...
export function sealProfessorV3YurikoProspectiveSmokeExecutionFailureV9(args: {
...
}): ProfessorV3SmokeFailureSealV9 {
  assertProfessorV3SmokeFailureDecisionV7(args.decision);
  const errMeta = resolveFailureErrorMetadata(args.error);
  const partialModelAttemptFiles = enumerateProfessorV3PartialModelAttemptFilesV9(args.targets.modelAttemptsDir);
  ...
  const failure: ProfessorV3SmokeFailureSealV9 = {
    version: PROFESSOR_V3_SMOKE_FAILURE_SEAL_V9_VERSION,
  ...
  const resultArtifact = {
    ...
    modelRequestBoundaryReached: failure.errorCode === PROFESSOR_V3_YURIKO_MODEL_REQUEST_BOUNDARY_REACHED_V1 ||
...
export { PROFESSOR_V3_YURIKO_MODEL_REQUEST_BOUNDARY_REACHED_V1 };
