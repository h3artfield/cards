/**
 * Shared Yuriko prospective Professor v3 smoke execution path — used by runner and sealing tests.
 */
import {
...
import {
  ...
  buildProfessorV3YurikoExecutableSmokeMaterialPinReportV1,
  type ProfessorV3ReviewedExecutionIdentityV9,
...
export const PROFESSOR_V3_YURIKO_PROSPECTIVE_SMOKE_EXECUTION_V1_VERSION =
  "phase6a1-professor-v3-yuriko-prospective-smoke-execution-v1";

export const PROFESSOR_V3_YURIKO_PROSPECTIVE_SMOKE_BINDING_V1 = {
...
export type ProfessorV3YurikoProspectiveSmokeExecutionBlockedV1 = {
  blocked: true;
  version: typeof PROFESSOR_V3_YURIKO_PROSPECTIVE_SMOKE_EXECUTION_V1_VERSION;
...
export type ProfessorV3YurikoProspectiveSmokeExecutionCompletedV1 = {
  blocked: false;
  version: typeof PROFESSOR_V3_YURIKO_PROSPECTIVE_SMOKE_EXECUTION_V1_VERSION;
  gate: ProfessorV3SmokeExecutionGateEvaluationV1;
  runner: ProfessorV3SmokeRunnerCaseBindingV1;
  ...
  materialPinReport: ReturnType<typeof buildProfessorV3YurikoExecutableSmokeMaterialPinReportV1>;
...
export type ProfessorV3YurikoProspectiveSmokeExecutionResultV1 =
  | ProfessorV3YurikoProspectiveSmokeExecutionBlockedV1
  | ProfessorV3YurikoProspectiveSmokeExecutionCompletedV1;

export function buildProfessorV3YurikoProspectiveRunnerBindingV1(args: {
  decision: string;
}): ProfessorV3SmokeRunnerCaseBindingV1 {
  return {
    decision: args.decision,
    caseId: PROFESSOR_V3_YURIKO_PROSPECTIVE_SMOKE_BINDING_V1.caseId,
    mechanismTruthCaseId: PROFESSOR_V3_YURIKO_PROSPECTIVE_SMOKE_BINDING_V1.mechanismTruthCaseId,
    stackIdentity: PROFESSOR_V3_YURIKO_PROSPECTIVE_SMOKE_BINDING_V1.stackIdentity,
  };
}

export async function runProfessorV3YurikoProspectiveSmokeExecutionV1(args: {
  authorization: ProfessorV3IndependentlyReviewedExecutionAuthorizationV8;
...
}): Promise<ProfessorV3YurikoProspectiveSmokeExecutionResultV1> {
  ...
  const targets = resolveProfessorV3SmokeYurikoProspectiveOutputTargetsV1(milestonesDir);
  const runner = buildProfessorV3YurikoProspectiveRunnerBindingV1({ decision: args.authorization.decision });
  ...
  if (gate.status !== "PREFLIGHT_ELIGIBLE") {
    return {
      blocked: true,
      version: PROFESSOR_V3_YURIKO_PROSPECTIVE_SMOKE_EXECUTION_V1_VERSION,
      gate,
      runner,
      authorization: args.authorization,
      outputTargets: targets,
      blockedArtifact: emitProfessorV3SmokeExecutionGateBlockedArtifactV1({
        version: "phase6a1-professor-v3-smoke-yuriko-prospective-blocked-v1",
  ...
  const identityVerification = assertProfessorV3YurikoExecutableSmokeExecutionPreflightV10({
    authorization: args.authorization,
  });
  const materialPinReport = buildProfessorV3YurikoExecutableSmokeMaterialPinReportV1(identityVerification);
  ...
  try {
    ...
    if (!entry) throw new Error(`Missing Yuriko mechanism truth for ${runner.mechanismTruthCaseId}`);
  ...
  let reachedStage: ProfessorV3YurikoProspectiveSmokeExecutionCompletedV1["reachedStage"] =
