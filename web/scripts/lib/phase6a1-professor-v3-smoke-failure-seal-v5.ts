...
} from "./phase6a1-professor-v3-smoke-material-pins-v4";
import type { ProfessorV3IndependentlyReviewedExecutionAuthorizationV5 } from "./phase6a1-professor-v3-smoke-execution-authorization-v5";
import type { ProfessorV3SmokeOutputTargetsV3 } from "./phase6a1-professor-v3-smoke-output-targets-v3";
import { sha256Bytes } from "./phase6a1-professor-v3-smoke-material-pins-v4";
...
export const PROFESSOR_V3_SMOKE_FAILURE_SEAL_V5_VERSION = "phase6a1-professor-v3-smoke-failure-seal-v5";

export type ProfessorV3PartialModelAttemptFileV5 = {
  path: string;
  byteSize: number;
  sha256: string;
};

export type ProfessorV3SmokeFailureSealV5 = {
  version: typeof PROFESSOR_V3_SMOKE_FAILURE_SEAL_V5_VERSION;
  generatedAt: string;
  decision: string;
  caseId: string;
  ...
  independentlyReviewedExecutionAuthorization: ProfessorV3IndependentlyReviewedExecutionAuthorizationV5;
  reviewedExecutionIdentity: ProfessorV3ReviewedExecutionIdentityV4;
  ...
  partialModelAttemptFiles: ProfessorV3PartialModelAttemptFileV5[];
...
export function enumerateProfessorV3PartialModelAttemptFilesV5(
  modelAttemptsDir: string,
): ProfessorV3PartialModelAttemptFileV5[] {
...
export function sealProfessorV3SmokeExecutionFailureV5(args: {
  targets: ProfessorV3SmokeOutputTargetsV3;
  caseId: string;
  executionStage: string;
  error: unknown;
  materialPins: { fileCount: number; files: ProfessorV3SmokeMaterialPinEntryV3[] };
  ...
  stderr?: string;
  decision?: string;
}): ProfessorV3SmokeFailureSealV5 {
  const err = args.error;
  const partialModelAttemptFiles = enumerateProfessorV3PartialModelAttemptFilesV5(args.targets.modelAttemptsDir);
  const failure: ProfessorV3SmokeFailureSealV5 = {
    version: PROFESSOR_V3_SMOKE_FAILURE_SEAL_V5_VERSION,
