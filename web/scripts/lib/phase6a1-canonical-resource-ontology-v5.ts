/**
 * Canonical typed resource ontology v5 — v4 symmetric repair preserved; RECOVERED_CREATURE destination fail-closed.
 */
import type { SemanticPackage } from "../../src/lib/deck-synthesis/professor-planning-contracts-v2";

export const CANONICAL_RESOURCE_ONTOLOGY_V5_VERSION = "phase6a1-canonical-resource-ontology-v5";
