/**
 * Parser-blind Gold Policy Validator v1.8 — validates benchmark answer keys.
 */
...
} from "./validation-v18-policy-adjudication";
...
export const GOLD_POLICY_VALIDATOR_VERSION = "gold-policy-validator-v1.8";
export const GOLD_POLICY_VERSION = "semantic-gold-policy-v1.8";
...
export function validateGoldAction(
...
export function validatorSourceHash(): string {
  return createHash("sha256")
    .update(`${GOLD_POLICY_VALIDATOR_VERSION}:${GOLD_POLICY_VERSION}:v1.8-core`)
    .digest("hex");
}
