#!/usr/bin/env npx tsx
/** Independent DEV adjudication author v8. */
...
export async function authorIndependentAdjudicationV8(
  snapshotDir: string,
  outputPath: string,
    ...
    JSON.stringify(
      {
        ...
        authoringPolicy: "DEV_TEMPLATE_STRUCTURAL_INFERENCE_V8_NOT_PRODUCTION_CLOSURE",
