#!/usr/bin/env npx tsx
/** Package semantic-opportunity repair artifacts for independent review. */
...
const OUT_ZIP = resolve(MILESTONES, "phase6a1-serialization-pilot-semantic-opportunity-repair-review-v1.zip");
const OUT_MANIFEST = resolve(MILESTONES, "phase6a1-serialization-pilot-semantic-opportunity-repair-review-v1-manifest.json");
...
const BUNDLE_FILES: Array<{ bundlePath: string; sourcePath: string }> = [
  ...
  {
    bundlePath: "scripts/lib/phase6a1-spent-pilot-audit-context-v1.ts",
    sourcePath: resolve(WEB, "scripts/lib/phase6a1-spent-pilot-audit-context-v1.ts"),
  },
  {
  ...
  {
    bundlePath: "scripts/run-phase6a1-build-spent-pilot-semantic-opportunity-supplement-v2.ts",
    sourcePath: resolve(WEB, "scripts/run-phase6a1-build-spent-pilot-semantic-opportunity-supplement-v2.ts"),
  },
  {
  ...
  {
    bundlePath: "scripts/run-phase6a1-audit-spent-pilot-normalizer-satisfiability-v2.ts",
    sourcePath: resolve(WEB, "scripts/run-phase6a1-audit-spent-pilot-normalizer-satisfiability-v2.ts"),
  },
  {
    bundlePath: "scripts/run-phase6a1-audit-professor-plan-context-preflight-v1.ts",
    sourcePath: resolve(WEB, "scripts/run-phase6a1-audit-professor-plan-context-preflight-v1.ts"),
  },
  {
    bundlePath: "scripts/test-phase6a1-professor-plan-context-preflight-v1.ts",
    sourcePath: resolve(WEB, "scripts/test-phase6a1-professor-plan-context-preflight-v1.ts"),
  },
  {
  ...
  {
    bundlePath: "scripts/run-phase6a1-package-serialization-pilot-semantic-opportunity-repair-review-v1.ts",
    sourcePath: resolve(WEB, "scripts/run-phase6a1-package-serialization-pilot-semantic-opportunity-repair-review-v1.ts"),
  },
];
...
function main() {
  ...
  const staging = resolve(MILESTONES, ".review-bundle-semantic-opportunity-repair-v1-staging");
  ...
  const manifest = {
    version: "phase6a1-serialization-pilot-semantic-opportunity-repair-review-v1-manifest",
    generatedAt: new Date().toISOString(),
    decision: "ROOT-CAUSE_REPAIR_SEMANTIC_OPPORTUNITY_COVERAGE",
    purpose:
      "Independent review package for semantic opportunity bridge repair, deterministic audits, Professor context preflight, and gate-v4 successor wrapper.",
