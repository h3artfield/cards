#!/usr/bin/env npx tsx
/** Package Professor v3 architecture review bundle. */
...
const OUT_ZIP = resolve(MILESTONES, "phase6a1-professor-v3-architecture-review-v1.zip");
const OUT_MANIFEST = resolve(MILESTONES, "phase6a1-professor-v3-architecture-review-v1-manifest.json");
...
const BUNDLE_FILES: Array<{ bundlePath: string; sourcePath: string }> = [
  ...
  { bundlePath: "scripts/run-phase6a1-test-professor-v3-grounding-fixtures-v1.ts", sourcePath: resolve(WEB, "scripts/run-phase6a1-test-professor-v3-grounding-fixtures-v1.ts") },
  ...
  { bundlePath: "milestones/deck-synthesis/phase6a1-professor-v3-grounding-fixtures-audit-v1.json", sourcePath: resolve(MILESTONES, "phase6a1-professor-v3-grounding-fixtures-audit-v1.json") },
  { bundlePath: "milestones/deck-synthesis/phase6a1-professor-v3-architecture-review-report-v1.json", sourcePath: resolve(MILESTONES, "phase6a1-professor-v3-architecture-review-report-v1.json") },
  ...
  { bundlePath: "scripts/run-phase6a1-report-professor-v3-architecture-v1.ts", sourcePath: resolve(WEB, "scripts/run-phase6a1-report-professor-v3-architecture-v1.ts") },
  { bundlePath: "scripts/run-phase6a1-package-professor-v3-architecture-review-v1.ts", sourcePath: resolve(WEB, "scripts/run-phase6a1-package-professor-v3-architecture-review-v1.ts") },
];
...
function main() {
  ...
  const staging = resolve(MILESTONES, ".review-bundle-professor-v3-architecture-v1-staging");
  ...
  const manifest = {
    version: "phase6a1-professor-v3-architecture-review-v1-manifest",
    generatedAt: new Date().toISOString(),
    decision: "PROFESSOR_V3_ARCHITECTURE_PIVOT",
    purpose: "Independent architecture review bundle for Professor v3 strategic synthesis + grounding validator. No model execution.",
