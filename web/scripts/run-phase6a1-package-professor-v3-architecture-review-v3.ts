#!/usr/bin/env npx tsx
/** Package Professor v3 architecture review bundle v3 — typed grounding + agent wiring. */
...
const OUT_ZIP = resolve(MILESTONES, "phase6a1-professor-v3-architecture-review-v3.zip");
const OUT_MANIFEST = resolve(MILESTONES, "phase6a1-professor-v3-architecture-review-v3-manifest.json");
...
const BUNDLE_FILES: Array<{ bundlePath: string; sourcePath: string }> = [
  ...
  { bundlePath: "scripts/run-phase6a1-test-professor-v3-grounding-fixtures-v3.ts", sourcePath: resolve(WEB, "scripts/run-phase6a1-test-professor-v3-grounding-fixtures-v3.ts") },
  ...
  { bundlePath: "milestones/deck-synthesis/phase6a1-professor-v3-grounding-fixtures-audit-v3.json", sourcePath: resolve(MILESTONES, "phase6a1-professor-v3-grounding-fixtures-audit-v3.json") },
  ...
  { bundlePath: "scripts/run-phase6a1-report-professor-v3-architecture-v3.ts", sourcePath: resolve(WEB, "scripts/run-phase6a1-report-professor-v3-architecture-v3.ts") },
  { bundlePath: "scripts/run-phase6a1-package-professor-v3-architecture-review-v3.ts", sourcePath: resolve(WEB, "scripts/run-phase6a1-package-professor-v3-architecture-review-v3.ts") },
];
...
function main() {
  ...
  const staging = resolve(MILESTONES, ".review-bundle-professor-v3-architecture-v3-staging");
  ...
  const manifest = {
    version: "phase6a1-professor-v3-architecture-review-v3-manifest",
    generatedAt: new Date().toISOString(),
    decision: "PROFESSOR_V3_ARCHITECTURE_CORE_PASS_MODEL_EXECUTION_BLOCK_V2_TYPED_GROUNDING_AND_AGENT_WIRING_REQUIRED",
    priorDecision: "PROFESSOR_V3_GROUNDING_CONTRACT_REPAIR_V2",
    purpose: "Independent architecture review v3 — typed strategic assertion grounding + agent orchestration. No model execution.",
    gateV4Status: "PREPARED_NOT_EXECUTED_SUPERSEDED",
    fixtureAudit: {
      artifact: "phase6a1-professor-v3-grounding-fixtures-audit-v3.json",
      totalFixtures: 32,
    },
