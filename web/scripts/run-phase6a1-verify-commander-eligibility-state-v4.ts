/**
 * Fail-closed verification of pinned Commander eligibility-state commitment v2 (v4 writer, atomic write-once).
 */
...
type EligibilityStateRoots = {
  fullEligibilityStateRootSha256: string;
  eligibleUniverseBeforeFreshness: { oracleIdCount: number; oracleIdSetSha256: string };
...
type Commitment = {
  ...
  expectedEligibilityStateRoots: EligibilityStateRoots;
