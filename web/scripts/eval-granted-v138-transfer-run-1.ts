/**
 * Single authorized v138 nested-grant transfer evaluation — parserExecutionCount 0 → 1.
...
function main() {
  const freeze = JSON.parse(
    readFileSync(resolve("data/milestones/rc3-development/granted-v138-parser-state-freeze.json"), "utf8"),
  );
  ...
  const report = {
    ...
    checkpoint: "granted-v138-transfer-evaluation-run-1",
  ...
  writeFileSync(
    resolve("data/milestones/rc3-development/granted-v138-transfer-run-1-report.json"),
