#!/usr/bin/env npx tsx
/** Independent DEV adjudication author v6 — dev-template inference only. */
...
export async function authorIndependentAdjudicationV6(
  snapshotDir: string,
  outputPath: string,
    ...
    JSON.stringify(
      {
        ...
        authoringPolicy: "DEV_TEMPLATE_STRUCTURAL_INFERENCE_V6_NOT_PRODUCTION_CLOSURE",
